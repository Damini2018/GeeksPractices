...
public class FlattenLinkedList
{
    ...
    Node flatten(Node root)
    {
        ...
        if (root == null || root.right == null)
          ...
          System.out.println("the list witht root");
        printListWithNode(root);

        // recur for list on right
        root.right = flatten(root.right);

        System.out.println("the list to flatten");
        printListWithNode(root);
        printListWithNode(root.right);
        // now merge
    ...
    void printListWithNode(Node node)
    {
        Node temp = node;
        while (temp != null)
        {
